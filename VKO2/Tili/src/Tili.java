//Tehtävässä pitää käsitellä pvm, joten importatataan .java.util.date sen tekemiseksi
...
public class Tili {
    ...
    //VKO3 asioita tästä lähtien
    public Tili(Tili Olio){
    ...
    public boolean suurempiKuin(Tili obj){
        if(this.get_saldo() > obj.get_saldo()){
            return true;
        }
        else{
            return false;
